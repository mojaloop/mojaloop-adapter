...
echo "** STARTUP - Checking for DB connection123..."

WAIT_FOR_DB_HOST=mysql-mojaloop-adapter
...
echo "$WAIT_FOR_DB_HOST, $WAIT_FOR_DB_PORT, $WAIT_FOR_DB_USER, $WAIT_FOR_DB_PASSWORD, $WAIT_FOR_DB_DATABASE"
