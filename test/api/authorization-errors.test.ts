...
describe('Authorization Errors Controller', function () {
  ...
  test('returns response code 200', async () => {
    ...
    expect(services.queueService.addToQueue).toHaveBeenCalledWith('ErrorResponses', { type: MojaloopError.authorization, typeId: '123', errorInformation: payload.errorInformation })
  })
